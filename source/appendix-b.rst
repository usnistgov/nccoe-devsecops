...
.. glossary::
   ...
   Artifact Repository (e.g., Internal and External)
      Manages the secure storage and retrieval of software artifacts (e.g., software libraries, Docker images, virtual machine images, or other software
   ...
   Artifact Signing and Verification Tool
      Digitally signs and verifies software components and artifacts, which could consist of source code, commits, Docker images, binaries, and software libraries,
   ...
   Attestation Signing and Verification Tool 
      ...
      in addition to information captured during the generation of the artifact (e.g., CI/CD components used, source code changes). 
   ...
   CI/CD Execution, Test and Security Policy Verification Tool
      Verifies that actions and results meet the CI/CD, test, and security policies.

   CI/CD Pipeline
      Provides continuous functionality in the develop/build/test/release/deploy/operate phases. It uses tools and scripts to build environments, source code,
      Docker images, and other software artifacts. This also provides an integration point for test and security tools (e.g., SAST, SCA, lint tool, or other
   ...
   Container Image Scanner
      Scans images and containerized assets for security vulnerabilities (e.g., vulnerable software packages, base images, and configurations).

   Credential Management System
      Manages, protects, and maintains software system or software application credentials (e.g., usernames, passwords, API keys, or secrets) that are
   ...
   Deployment Management System (e.g., Release Orchestration, Rollback, and Canary)
      Manages the deployment of artifacts into the operational environment. This can include different strategies (e.g., canary-based, rolling, blue/green,
      red/black, or testing in production) to control the deployment of software/system assets, feature components, and configurations into the operational
      environment.
   ...
   IaC Scripts
      Creates or modifies infrastructure resources (e.g., hosts, networks, and services) as part of the provisioning and management of various deployment
   ...
   Operations Monitoring System (e.g., Infrastructure Management, Log Management, and Performance Monitoring)
      ...
      also includes the generation of logs, detected defects/vulnerabilities, and system statuses.

   Package Management System
      Collects release packages by utilizing software repositories and dependencies (e.g., software libraries or packages) for distribution. This can include
      tools and processes for organizing, tracking, and securing distributed artifacts.

   Product Management System
      Manages and maintains the designs and artifacts necessary to deliver products, features, and functionality to stakeholders. This can include
   ...
   Provenance Generation and Verification Tool 
      Generates and verifies SBOM information (e.g., software dependencies, configuration files, scripts, or source code) that is included in the 
   ...
   Release Management System
      Manages the software release process (e.g., the planning, coordinating, notification, and distribution) of software applications, libraries, or packages.
   ...
   SAST System
      Analyzes source code for defects, security vulnerabilities (e.g., SQL injection, cross-site scripting, buffer overflow, or leaked secrets or
   ...
   SCM System (e.g., Version Control, Commit Hooks, and Branch/Merge Protection)
      ...
      tags, merge/pull requests, and forks). This can also provide version control and change monitoring for source code. Additional functionality
      includes commit hooks and branch/merge protections to provide automated control over security scans, lint tools, or merge/pull request approvals for
      software repositories and source code.

   Secrets Management System
      Manages, protects, and maintains secrets (e.g., usernames, passwords, API keys, or configuration details) that are assigned to software applications or
      services for use in machine-to-machine integration (e.g., authentication, authorization, or configuration).

   Secret Scanner
      Scans for exposed secrets (e.g., certificate keys, credentials, API keys, and other sensitive variables) in source code or configuration files to
   ...
   Security Monitoring System (e.g., Vulnerability Management, Incident Management, Security Information and Event Management (SIEM), and Security Orchestration, Automation, and Response (SOAR))
      Manages detection, analysis, and categorization and responds to security threats, vulnerabilities and compromises by providing tools to analyze event data,
   ...
   Threat Modeling System
      ...
      exploited vulnerabilities). This can also provide the necessary reports and notifications to track risk at the organizational, system, or application levels for stakeholders.

   Ticketing System
      Manages tracking of tasks and bugs identified in prior iterations of the DevSecOps lifecycle for software systems and applications. This
      includes the creation, assignment, and resolution of tasks and roles (e.g., tickets, issues, or work items) to different groups (e.g., projects, teams,
      or individuals).
   ...
   Zero Trust Security System
      An overarching security architecture that enables robust authentication, authorization, policy assignment, policy enforcement, continuous monitoring, and
